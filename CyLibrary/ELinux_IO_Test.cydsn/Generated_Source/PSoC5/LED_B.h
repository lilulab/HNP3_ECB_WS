...
*/
     ...
     *  @{
     */
        #define LED_B_INTR_NONE      (uint16)(0x0000u)
        #define LED_B_INTR_RISING    (uint16)(0x0001u)
        #define LED_B_INTR_FALLING   (uint16)(0x0002u)
        #define LED_B_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define LED_B_INTR_MASK      (0x01u) 
#endif /* (LED_B__INTSTAT) */
...
/* SIO registers */
#if defined(LED_B__SIO_CFG)
    #define LED_B_SIO_HYST_EN        (* (reg8 *) LED_B__SIO_HYST_EN)
    #define LED_B_SIO_REG_HIFREQ     (* (reg8 *) LED_B__SIO_REG_HIFREQ)
    #define LED_B_SIO_CFG            (* (reg8 *) LED_B__SIO_CFG)
    #define LED_B_SIO_DIFF           (* (reg8 *) LED_B__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define LED_B_0_INTTYPE_REG 		(* (reg8 *) LED_B__0__INTTYPE)
#endif /* (LED_B__INTSTAT) */
