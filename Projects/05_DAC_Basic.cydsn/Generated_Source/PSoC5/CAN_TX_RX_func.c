...
void CAN_TxCancel(uint8 bufferId) 
{
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgM_SWITCH_STATUS
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgM_SWITCH_STATUS(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_M_SWITCH_STATUS_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_M_SWITCH_STATUS_CALLBACK
                    CAN_SendMsg_M_SWITCH_STATUS_Callback();
                #endif /* CAN_SEND_MSG_M_SWITCH_STATUS_CALLBACK */
    ...
    /*******************************************************************************
    * FUNCTION NAME:   CAN_SendMsgM_LED_STATUS
    ********************************************************************************
    *
    * Summary:
    ...
    *
    *******************************************************************************/
    uint8 CAN_SendMsgM_LED_STATUS(void) 
    {
        uint8 result = CYRET_SUCCESS;
            ...
            {
                /* `#START MESSAGE_M_LED_STATUS_TRASMITTED` */

                /* `#END` */

                #ifdef CAN_SEND_MSG_M_LED_STATUS_CALLBACK
                    CAN_SendMsg_M_LED_STATUS_Callback();
                #endif /* CAN_SEND_MSG_M_LED_STATUS_CALLBACK */
