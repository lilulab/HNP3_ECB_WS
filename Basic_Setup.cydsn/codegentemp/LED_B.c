...
*
* \funcusage
*  \snippet LED_B_SUT.c usage_LED_B_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED_B_SUT.c usage_LED_B_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LED_B_SUT.c usage_LED_B_Read  
*******************************************************************************/
...
* preferred LED_B_Read() API because the 
* LED_B_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LED_B_SUT.c usage_LED_B_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: LED_B_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use LED_B_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - LED_B_0_INTR       (First pin in the list)
    *  - LED_B_1_INTR       (Second pin in the list)
    *  - ...
    *  - LED_B_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet LED_B_SUT.c usage_LED_B_SetInterruptMode
    *******************************************************************************/
    void LED_B_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & LED_B_0_INTR) != 0u) 
		{ 
			 LED_B_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet LED_B_SUT.c usage_LED_B_ClearInterrupt
    *******************************************************************************/
