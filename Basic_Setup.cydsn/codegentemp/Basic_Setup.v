...
module ADC_SAR_v3_0_0 (
	...
	cy_clock_v1_0
		#(.id("e7ff735e-badc-4dfb-957f-69c75ca1b178/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=57600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=460800, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=UART_v2_50, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_LINUX_0, CY_INSTANCE_SHORT_NAME=UART_LINUX_0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=UART_LINUX_0, )
module UART_v2_50_7 (
    cts_n,
    tx,
    rts_n,
	...
	cy_clock_v1_0
		#(.id("03442099-b14f-4f75-b95b-b3d49d44f976/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("2170138888.88889"),
		  .is_direct(0),
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_2, CY_INSTANCE_SHORT_NAME=ADC_SAR_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=ADC_SAR_2, )
module ADC_SAR_v3_0_10 (
	...
	cy_clock_v1_0
		#(.id("e602ad2e-a4c1-41f4-95db-90f893a5a90c/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
    ...
    reg [7:0] AMuxHw_1_Decoder_one_hot;
    reg [2:0] AMuxHw_1_Decoder_old_id;
    ...
    assign AMuxHw_1_Decoder_is_active = (Net_2970[2:0] == AMuxHw_1_Decoder_old_id) && AMuxHw_1_Decoder_enable;
    
    always @(posedge Net_3027)
    begin
        AMuxHw_1_Decoder_old_id = Net_2970[2:0];
    end
    
    generate
        for (AMuxHw_1_Decoder_i = 0; AMuxHw_1_Decoder_i < 8; AMuxHw_1_Decoder_i = AMuxHw_1_Decoder_i + 1 )
    ...
    cy_psoc3_amux_v1_0 #(
        ...
        .hw_ctrl_en(AMuxHw_1_Decoder_one_hot[7:0]),
        .vout(Net_2988)
        );
    ...
    assign Net_5349 = 1'h1;

    UART_v2_50_7 UART_LINUX_0 (
        .cts_n(1'b0),
        .tx(Net_810),
        .rts_n(Net_834),
        .tx_en(Net_835),
        ...
        .reset(1'b0),
        .rx(Net_815),
        .tx_interrupt(Net_838),
        .rx_interrupt(Net_839),
        .tx_data(Net_840),
        .tx_clk(Net_841),
        .rx_data(Net_842),
        .rx_clk(Net_843));
    defparam UART_LINUX_0.Address1 = 0;
    defparam UART_LINUX_0.Address2 = 0;
    defparam UART_LINUX_0.EnIntRXInterrupt = 0;
    defparam UART_LINUX_0.EnIntTXInterrupt = 0;
    defparam UART_LINUX_0.FlowControl = 0;
    defparam UART_LINUX_0.HalfDuplexEn = 0;
    defparam UART_LINUX_0.HwTXEnSignal = 1;
    defparam UART_LINUX_0.NumDataBits = 8;
    defparam UART_LINUX_0.NumStopBits = 1;
    defparam UART_LINUX_0.ParityType = 0;
    defparam UART_LINUX_0.RXEnable = 1;
    defparam UART_LINUX_0.TXEnable = 1;

    UART_v2_50_8 UART_STIM_1 (
        .cts_n(1'b0),
        .tx(Net_797),
        .rts_n(Net_798),
        .tx_en(Net_799),
	...
	wire [0:0] tmpOE__UART_LINUX_0_TXD_net;
	wire [0:0] tmpFB_0__UART_LINUX_0_TXD_net;
	wire [0:0] tmpIO_0__UART_LINUX_0_TXD_net;
	wire [0:0] tmpINTERRUPT_0__UART_LINUX_0_TXD_net;
	electrical [0:0] tmpSIOVREF__UART_LINUX_0_TXD_net;

	cy_psoc3_pins_v1_10
		#(.id("4f1fb627-5d4b-48a3-bc4c-d982765baa38"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UART_LINUX_0_TXD
		 (.oe(tmpOE__UART_LINUX_0_TXD_net),
		  .y({Net_810}),
		  .fb({tmpFB_0__UART_LINUX_0_TXD_net[0:0]}),
		  .io({tmpIO_0__UART_LINUX_0_TXD_net[0:0]}),
		  .siovref(tmpSIOVREF__UART_LINUX_0_TXD_net),
		  .interrupt({tmpINTERRUPT_0__UART_LINUX_0_TXD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UART_LINUX_0_TXD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UART_LINUX_0_RXD_net;
	wire [0:0] tmpIO_0__UART_LINUX_0_RXD_net;
	wire [0:0] tmpINTERRUPT_0__UART_LINUX_0_RXD_net;
	electrical [0:0] tmpSIOVREF__UART_LINUX_0_RXD_net;

	cy_psoc3_pins_v1_10
		#(.id("58b63e1c-1acf-4eb4-a1bd-9434a295ba05"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		UART_LINUX_0_RXD
		 (.oe(tmpOE__UART_LINUX_0_RXD_net),
		  .y({1'b0}),
		  .fb({Net_815}),
		  .io({tmpIO_0__UART_LINUX_0_RXD_net[0:0]}),
		  .siovref(tmpSIOVREF__UART_LINUX_0_RXD_net),
		  .interrupt({tmpINTERRUPT_0__UART_LINUX_0_RXD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UART_LINUX_0_RXD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam Control_Reg_3.BusDisplay = 0;
	...
	cy_clock_v1_0
		#(.id("3f044459-eb3c-4de8-92a6-915cba15efa7"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    reg [7:0] AMuxHw_2_Decoder_one_hot;
    reg [2:0] AMuxHw_2_Decoder_old_id;
    ...
    assign AMuxHw_2_Decoder_is_active = (Net_3026[2:0] == AMuxHw_2_Decoder_old_id) && AMuxHw_2_Decoder_enable;
    
    always @(posedge Net_3027)
    begin
        AMuxHw_2_Decoder_old_id = Net_3026[2:0];
    end
    
    generate
        for (AMuxHw_2_Decoder_i = 0; AMuxHw_2_Decoder_i < 8; AMuxHw_2_Decoder_i = AMuxHw_2_Decoder_i + 1 )
    ...
    cy_psoc3_amux_v1_0 #(
        ...
        .hw_ctrl_en(AMuxHw_2_Decoder_one_hot[7:0]),
        .vout(Net_3025)
        );
    ...
    defparam Control_Reg_2.NumOutputs = 3;
